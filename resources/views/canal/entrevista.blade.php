...
<body>
    <div class="container">
        ...
        <div class="row mt-5 completo">
            <div class="col toca1">
                <h1 class="titulo">Canal de Entrevista e Contrato</h1>
            ...
            <div class="col">
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="Contacto">
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" id="exampleFormControlInput1"
                            placeholder="Colégio/ Escola que frequentou">
                    </div>
                    <div class="mb-3">
                        <label for="">Data que deseja marcar</label>
